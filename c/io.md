...
int main()
{
    printf("C程序设计（第五版）");  //显示引号中的内容
    return 0;
}
```

```bash
gcc /share/lesson/c/io.c && ./a.out
```
...
```bash
gcc /share/lesson/c/io-formatd.c && ./a.out
```
...
```bash
gcc /share/lesson/c/io-formatf.c && ./a.out
```
...
```bash
gcc /share/lesson/c/io-getcharputchar.c && ./a.out
```
...
```bash
gcc /share/lesson/c/io-getput.c && ./a.out
```
...
```bash
gcc /share/lesson/c/io-scanfprintf.c && ./a.out
```
